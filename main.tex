...
\item \textbf{No non-LLM baseline.} We calibrate difficulty only against trivial always-safe/always-vulnerable baselines; adding a static-analysis detector (e.g.\ CodeQL or Semgrep) and a fine-tuned learned detector on the same functions would place the LLM results on an absolute scale and is a priority extension.
